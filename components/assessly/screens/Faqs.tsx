  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Open it from Ongoing Generations to see the stage it stopped at. Transient failures usually succeed on a fresh run with the same settings. If a run repeatedly fails, send us the details through the Feedback page — it captures your team automatically.",
      },
    ],
  },
];
  ...
  return (
    <div style={{ maxWidth: 980, margin: "0 auto" }}>
      ...
      <div style={{ padding: "6px 4px 30px", fontSize: 14, color: C.muted }}>
        Didn&apos;t find your answer? Tell us on the <b>Feedback</b> page — it goes straight to the product team.
      </div>
    </div>
  );
}
