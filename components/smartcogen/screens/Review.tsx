...
//
// Everything is inline-styled to match the SmartCoGen design pixel-for-pixel.
...
export function Review() {
  const { reviewRunId, runs, setReviewBar, markFinalised, go, toast, user } = useSmartCoGen();
